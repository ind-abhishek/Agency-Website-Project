    ...
    <>
      ...
      <div className="RootWrap">
          ...
          <div className="mainContainer">
            ...
            <div className="home screen mx-auto max-w-screen-xl items-center px-50">
              ...
              <div className="mt-12 flex justify-start ">
                <button className="mr-12 rounded-md p-0 mt-6 h-12  notbtn3 ">
                  <a href="#">
                    view work <MdArrowOutward className="inline" />
                  </a>
                </button>

                <div className="pplCard flex  ">
        ...
        <div className="serviceWrapper" id="Service">
          <div className="pageContainer screen mx-auto max-w-screen-xl  ">
            <BgLine className=""></BgLine>
            <h3 className="head tracking-[.35em]">SERVICE</h3>
            <h1 className="titel">Exceeding Expectations</h1>
            <div className="descContain">
              <h3 className="desc">
                We're not just another agency; we're your path to exceptional
                web projects.
              </h3>
            </div>
        ...
        <div className="portfolioWrapper" id="Portfolio">
          <div className="pageContainer  screen mx-auto max-w-screen-xl  ">
            ...
            <div className="descContain">
              <h3 className="desc">
                Discover our freshest creations that showcase the power of
                design innovation and digital excellence. Explore our latest
                work and witness the impact we bring to every project
              </h3>
            </div>
            ...
            <div className="cardContain gap-5">
              ...
              <div className="priceCard rounded-lg mt-5 ">
                ...
                <p className="priceDesc">
                  Fully responsive I page website, developed in Webflow,
                  Unlimited Sections.
                </p>
